#[monerochan_test::monerochan_test("curve25519_ng_decompress", syscalls = [ED_DECOMPRESS], prove)]
fn test_decompressed_noncanonical(
    _stdin: &mut monerochan::MONEROCHANStdin,
...
#[monerochan_test::monerochan_test("curve25519_ng_add_then_multiply", syscalls = [ED_ADD, ED_DECOMPRESS], prove)]
...
#[monerochan_test::monerochan_test("curve25519_ng_zero_msm", syscalls = [ED_ADD, ED_DECOMPRESS], prove)]
...
#[monerochan_test::monerochan_test("curve25519_ng_zero_mul", syscalls = [ED_ADD, ED_DECOMPRESS], prove)]
