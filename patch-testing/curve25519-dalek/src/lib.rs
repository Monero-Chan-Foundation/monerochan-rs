#[monerochan_test::monerochan_test("curve25519_decompress", syscalls = [ED_DECOMPRESS])]
...
#[monerochan_test::monerochan_test("curve25519_decompress")]
...
#[monerochan_test::monerochan_test("ed25519_verify", syscalls = [ED_ADD, ED_DECOMPRESS])]
fn test_ed25519_verify(stdin: &mut monerochan::MONEROCHANStdin) -> impl FnOnce(monerochan::MONEROCHANPublicValues) {
    use ed25519_dalek::Signer;

    let how_many_signatures = monerochan_test::DEFAULT_CORPUS_COUNT as usize;
...
#[monerochan_test::monerochan_test("curve25519_add_then_multiply", syscalls = [ED_ADD, ED_DECOMPRESS], prove)]
fn test_add_then_multiply(stdin: &mut monerochan::MONEROCHANStdin) -> impl FnOnce(monerochan::MONEROCHANPublicValues) {
...
#[monerochan_test::monerochan_test("curve25519_zero_mul", syscalls = [ED_ADD, ED_DECOMPRESS], prove)]
fn test_zero_mul(_stdin: &mut monerochan::MONEROCHANStdin) -> impl FnOnce(monerochan::MONEROCHANPublicValues) {
