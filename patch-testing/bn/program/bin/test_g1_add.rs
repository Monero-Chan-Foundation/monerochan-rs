...
pub fn main() {
    ...
    for _ in 0..times {
        let a_x: Vec<u8> = monerochan_lib::io::read();
        let a_y: Vec<u8> = monerochan_lib::io::read();
        let b_x: Vec<u8> = monerochan_lib::io::read();
        let b_y: Vec<u8> = monerochan_lib::io::read();
        let c_x: Vec<u8> = monerochan_lib::io::read();
        let c_y: Vec<u8> = monerochan_lib::io::read();
