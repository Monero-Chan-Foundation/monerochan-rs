#[monerochan_test::monerochan_test("bn_test_fq_sqrt", syscalls = [BN254_FP_MUL], gpu, prove)]
...
#[monerochan_test::monerochan_test("bn_test_fq_inverse", syscalls = [BN254_FP_MUL], gpu, prove)]
...
#[monerochan_test::monerochan_test("bn_test_fr_inverse", syscalls = [UINT256_MUL], gpu, prove)]
...
#[monerochan_test::monerochan_test("bn_test_g1_add", syscalls = [BN254_ADD, BN254_FP_ADD, BN254_FP_MUL], gpu, prove)]
