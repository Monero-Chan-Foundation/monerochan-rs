...
#[monerochan_test::monerochan_test("p256_recover", syscalls = [SECP256R1_ADD, SECP256R1_DOUBLE], gpu, prove)]
...
#[monerochan_test::monerochan_test("p256_recover", syscalls = [SECP256R1_ADD, SECP256R1_DOUBLE])]
