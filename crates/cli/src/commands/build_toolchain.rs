...
#[derive(Parser)]
#[command(name = "build-toolchain", about = "Build the cargo-monerochan toolchain.")]
        ...
        let rust_dir = match build_dir {
            ...
            Err(_) => {
                ...
                Command::new("git")
                    ...
                    .run()
                    .with_context(|| format!("Failed to clone repository from {repo_url}. Make sure the repository exists and you have access to it."))?;
                
                // Verify the directory was created
                if !dir.exists() {
                    return Err(anyhow::anyhow!("Clone completed but directory {} does not exist", dir.display()));
                }
                ...
                Command::new("git")
                    ...
                    .current_dir(&dir)
                    .run()
                    .with_context(|| format!("Failed to reset repository in {}", dir.display()))?;
                ...
                Command::new("git")
                    ...
                    .current_dir(&dir)
                    .run()
                    .with_context(|| format!("Failed to update submodules in {}", dir.display()))?;
