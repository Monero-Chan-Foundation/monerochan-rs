...
/// ### Examples
/// ```ignore
/// let data: Vec<u8> = monerochan_runtime::io::read_vec();
/// ```
#[track_caller]
pub fn read_vec() -> Vec<u8> {
    ...
    if ptr.is_null() {
        panic!(
            ...
            Was the correct data written into MONEROCHANStdin?",
...
/// }
///
/// let data: MyStruct = monerochan_runtime::io::read();
/// ```
#[track_caller]
...
///     b: 2,
/// };
/// monerochan_runtime::io::commit(&data);
/// ```
...
/// monerochan_runtime::io::commit_slice(&data);
/// ```
...
///     b: 2,
/// };
/// monerochan_runtime::io::hint(&data);
/// ```
...
/// ```ignore
/// let data = vec![1, 2, 3, 4];
/// monerochan_runtime::io::hint_slice(&data);
/// ```
...
/// ```ignore
/// let data = vec![1, 2, 3, 4];
/// monerochan_runtime::io::write(3, &data);
/// ```
