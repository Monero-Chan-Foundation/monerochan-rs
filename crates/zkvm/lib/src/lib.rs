...
extern "C" {
    ...
    /// Defers the verification of a valid MONEROCHAN zkVM proof.
    pub fn syscall_verify_monerochan_proof(vk_digest: &[u32; 8], pv_digest: &[u8; 32]);
