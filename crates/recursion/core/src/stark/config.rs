...
use monerochan_stark::{Com, StarkGenericConfig, ZeroCommitment};

use super::{poseidon2::bn254_poseidon2_rc3, monerochan_dev_mode};
...
pub fn outer_fri_config() -> FriConfig<OuterChallengeMmcs> {
    ...
    let num_queries = if monerochan_dev_mode() {
        1
    } else {
