...
fn main() {
    cfg_if! {
        if #[cfg(feature = "native")] {
            ...
            // Example: MONEROCHAN_GNARK_FFI_GO_ENVS="CC=clang-cl;CCC_OVERRIDE_OPTIONS=x-dM"
            let go_envs: HashMap<String, String> = match env::var("MONEROCHAN_GNARK_FFI_GO_ENVS") {
            ...
            if cfg!(target_os = "macos") {
                ...
                if env::var("MONEROCHAN_GNARK_FFI_SKIP_MAC_FRAMEWORKS").is_err() {
