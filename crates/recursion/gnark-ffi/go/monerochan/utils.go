...
func NewMONEROCHANPlonkBn254Proof(proof *plonk.Proof, witnessInput WitnessInput) Proof {
...
func NewMONEROCHANGroth16Proof(proof *groth16.Proof, witnessInput WitnessInput) Proof {
	var buf bytes.Buffer
	(*proof).WriteRawTo(&buf)
	proofBytes := buf.Bytes()
