...
import (
	...
	"github.com/monero-chan-foundation/monerochan-rs-recursion-gnark/monerochan/trusted_setup"
)

// Modify the PlonkVerifier so that it works with the MONEROCHANVerifier.
...
// Modify the Groth16Verifier so that it works with the MONEROCHANVerifier.
