...
/// A trait that contains the common helper methods for building `MONEROCHAN recursion` and MONEROCHAN machine
/// AIRs.
...
/// A trait which contains all helper methods for building MONEROCHAN machine AIRs.
pub trait MONEROCHANAirBuilder: MachineAirBuilder + ByteAirBuilder + InstructionAirBuilder {}
...
impl<AB: BaseAirBuilder + AirBuilderWithPublicValues> MONEROCHANAirBuilder for AB {}
