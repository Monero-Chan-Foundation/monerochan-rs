...
/// The number of non padded elements in the MONEROCHAN proofs public values vec.
pub const MONEROCHAN_PROOF_NUM_PV_ELTS: usize = size_of::<PublicValues<Word<u8>, u8>>();

/// The number of 32 bit words in the MONEROCHAN proof's committed value digest.
...
mod tests {
    ...
    fn test_public_values_digest_num_words_consistency_zkvm() {
        assert_eq!(public_values::PV_DIGEST_NUM_WORDS, monerochan_runtime::PV_DIGEST_NUM_WORDS);
    }
}
