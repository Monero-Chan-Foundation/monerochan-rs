...
impl PlonkVerifier {
    /// Verifies an MONEROCHAN PLONK proof, as generated by the MONEROCHAN SDK.
    ///
    /// # Arguments
    ///
    ...
    pub fn verify(
        ...
        //
        // MONEROCHAN prepends the raw Plonk proof with the first 4 bytes of the plonk vkey to
