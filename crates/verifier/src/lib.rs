//! This crate provides verifiers for MONEROCHAN Groth16 and Plonk BN254 proofs in a no-std environment.
//! It is patched for efficient verification within the MONEROCHAN zkVM context.
...
lazy_static! {
    /// The PLONK verifying key for this MONEROCHAN version.
    pub static ref PLONK_VK_BYTES: &'static [u8] = include_bytes!("../bn254-vk/plonk_vk.bin");
}

lazy_static! {
    /// The Groth16 verifying key for this MONEROCHAN version.
