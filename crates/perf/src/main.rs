...
use monerochan_prover::{components::CpuProverComponents, HashableKey, ProverMode};
use monerochan::{self, Prover, ProverClient, MONEROCHANContext, MONEROCHANProver, MONEROCHANStdin};
...
fn main() {
    ...
    match args.mode {
        ...
        ProverMode::Cuda => {
            let server = MONEROCHANCudaProver::new(MoongateServer::default())
